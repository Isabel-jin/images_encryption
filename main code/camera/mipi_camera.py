...
from img_jiemi import img_jiemi
...
if __name__ == '__main__':
    ...
    while True:
        ...
        bgr_img = cv2.cvtColor(img.reshape((height*3//2, width)), cv2.COLOR_YUV2BGR_NV12)   # nv12转BGR
        jiami_img = predict_cut(outputs, model_hw_shape=(512, 512), origin_image=bgr_img)
        cv2.imwrite("img_jiami.jpg",jiami_img)
        r=np.array([0.343, 0.432, 0.63 ,3.769 ,3.82, 3.8, 0.1 ,1])#密钥
        jiemi_img = img_jiemi(jiami_img,r)#解密
        cv2.imwrite("img_jiemi.jpg",jiemi_img)
